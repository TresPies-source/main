...
export function LicenseContent() {
    return (
        <Card>
            <CardHeader>
                <CardTitle className="font-headline">ZenJar Application Software License</CardTitle>
                <CardDescription>Last Updated: July 30, 2025</CardDescription>
            </CardHeader>
            <CardContent>
                <div className="prose prose-stone dark:prose-invert max-w-none">
                    <p>This Software License Agreement ("License") is a legal agreement between you ("Licensee" or "You") and ZenJar ("Licensor," "we," "us," or "our") for the use of the ZenJar application software, including its web application, browser extensions, chat bot integrations (Slack, Discord), and any associated documentation, updates, and AI models ("Software").</p>
                    <p>By installing, accessing, or using the Software, you agree to be bound by the terms of this License. If you do not agree to the terms of this License, do not install, access, or use the Software.</p>

                    <h2>1. Grant of License</h2>
                    <p>Subject to the terms and conditions of this License, ZenJar grants You a limited, non-exclusive, non-transferable, non-sublicensable, and revocable license to:</p>
                    <ul>
                    ...
                    <h2>3. Ownership</h2>
                    <p>The Software is licensed, not sold. ZenJar retains all right, title, and interest in and to the Software, including all copyrights, trademarks, trade secrets, patents, and any other intellectual property rights. This License does not grant you any ownership rights in the Software.</p>

                    <h2>4. No Warranty</h2>
                    <p>THE SOFTWARE IS PROVIDED "AS IS," WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO THE WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NONINFRINGEMENT. ZENJAR DOES NOT WARRANT THAT THE SOFTWARE WILL MEET YOUR REQUIREMENTS, OPERATE WITHOUT INTERRUPTION, BE ERROR-FREE, OR BE COMPATIBLE WITH ANY PARTICULAR HARDWARE OR SOFTWARE.</p>

                    <h2>5. Limitation of Liability</h2>
                    <p>TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL ZENJAR BE LIABLE FOR ANY INCIDENTAL, SPECIAL, INDIRECT, OR CONSEQUENTIAL DAMAGES WHATSOEVER, INCLUDING, WITHOUT LIMITATION, DAMAGES FOR LOSS OF PROFITS, LOSS OF DATA, BUSINESS INTERRUPTION, OR ANY OTHER COMMERCIAL DAMAGES OR LOSSES, ARISING OUT OF OR RELATED TO YOUR USE OR INABILITY TO USE THE SOFTWARE, HOWEVER CAUSED, REGARDLESS OF THE THEORY OF LIABILITY (CONTRACT, TORT, OR OTHERWISE) AND EVEN IF ZENJAR HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.</p>
                    ...
                    <p>This License shall be governed by and construed in accordance with the laws of [Your Jurisdiction, e.g., the State of California], without regard to its conflict of law principles.</p>

                    <h2>8. Entire Agreement</h2>
                    <p>This License constitutes the entire agreement between you and ZenJar regarding the use of the Software and supersedes all prior or contemporaneous understandings and agreements, whether written or oral, regarding such subject matter.</p>

                    <h2>9. Contact Information</h2>
                    <p>If you have any questions about this License, please contact us at:</p>
                    <p>help@trespiesdesign.com</p>
                    <p>zenjarapp.com</p>
                </div>
            </CardContent>
        </Card>
