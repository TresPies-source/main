...
export function PrivacyContent() {
    return (
        <Card>
            <CardHeader>
                <CardTitle className="font-headline">ZenJar App Privacy Policy</CardTitle>
                <CardDescription>Last Updated: July 30, 2025</CardDescription>
            </CardHeader>
            <CardContent>
                <div className="prose prose-stone dark:prose-invert max-w-none">
                    <p>This Privacy Policy describes how ZenJar ("we," "us," or "our") collects, uses, and discloses your information in connection with your use of our ZenJar application (the "App"), including its web, browser extension, and chat bot integrations (Slack, Discord), and any related services.</p>
                    <p>By accessing or using the App, you agree to the collection, use, and disclosure of your information as described in this Privacy Policy. If you do not agree with the terms of this Privacy Policy, please do not use the App.</p>
                    ...
                    <p><strong>Storage Location:</strong> Your data is stored in Google Cloud's Firestore database, which adheres to Google's robust security standards.</p>
                    <p><strong>Security Measures:</strong> We implement technical and organizational measures designed to protect your information from unauthorized access, disclosure, alteration, or destruction. These measures include encryption in transit and at rest, access controls, and regular security reviews.</p>
                    <p><strong>User Responsibility:</strong> While we strive to protect your personal information, no method of transmission over the Internet or electronic storage is 100% secure. You are responsible for maintaining the confidentiality of your account credentials.</p>
